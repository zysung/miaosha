...
import cn.zysung.miaosha.utils.ValidatorUtil;
...
public class LoginController {
    ...
    @ResponseBody
    public Result<String> doLogin(HttpServletResponse response,@Valid LoginVo loginVo){//加JSR303
        logger.info(loginVo.toString());
//        //参数校验,后改为JSR303直接注解校验
